...
def main():
    ...
    # Ensure all autogenerated subdirectories exist
    for subdir in ['autogenerated', 'autogenerated/subFONDs', 'autogenerated/cache',
                   'autogenerated/domain_steps_configJSON', 'autogenerated/domain_template']:
        create_dir_not_exist(subdir)
    ...
    for ll_problem in problems_list: 
        ...
        create_dir_not_exist("autogenerated/cache")
