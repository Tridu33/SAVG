...
############################### start to prove! ####################################
hig = Or(And(Not(clear(Bottom)),Not(Exists([x],(And(isRed(x),holding(x))))),Not(Exists([x],(And(isGreen(x),holding(x))))),Not(Exists([x],(And(isBlue(x),holding(x))))) ))
low = And(arm_empty,Not(clear(Bottom)),Not(Exists([x],(isRed(x),holding(x)))),Not(Exists([x],(isGreen(x),holding(x)))),Not(Exists([x],(isBlue(x),holding(x)))))
goal = And(
    Implies(
