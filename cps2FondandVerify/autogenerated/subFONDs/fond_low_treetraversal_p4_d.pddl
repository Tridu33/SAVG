...
(define (domain low_treetraversal_p4_d)
    ...
    (:action 36_rootiscur2q_35
        ...
        :effect (and (not(vStart)) (not(vGoal)) (curIsRoot) (not(allvisited)) (not(SomeNodesMissed)) (not(lenis0)) (lenis1) (curhasunpushedkids) )
    )
    ...
    (:action 32_extract_1
        ...
        :effect (and (not(vStart)) (not(vGoal)) (not(curIsRoot)) (not(allvisited)) (not(SomeNodesMissed)) (not(lenis0)) (not(lenis1)) (curhasunpushedkids) )
    )
    ...
    (:action 1_extract_10
            :parameters ()
        :precondition (and (not(vStart)) (not(vGoal)) (not(curIsRoot)) (not(allvisited)) (not(SomeNodesMissed)) (not(lenis0)) (not(lenis1)) (curhasunpushedkids) )
        :effect (and (not(vStart)) (not(vGoal)) (not(curIsRoot)) (not(allvisited)) (SomeNodesMissed) (not(lenis0)) (lenis1) (not(curhasunpushedkids)) )
    )
