...
(define (domain low_treetraversal_p2_d)
    ...
    (:action 0_extract_2
        ...
        :effect (and (not(vStart)) (not(vGoal)) (not(curIsRoot)) (not(allvisited)) (not(SomeNodesMissed)) (not(lenis0)) (lenis1) (not(curhasunpushedkids)) )
    )
    (:action 2_extract_84
            :parameters ()
